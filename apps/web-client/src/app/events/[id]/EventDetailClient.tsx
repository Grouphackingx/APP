        ...
        <div className="share-modal-overlay" onClick={() => setShareOpen(false)}>
          <div className="share-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="share-modal-networks">
              ...
              >
                <span className="share-network-icon" style={{ background: '#1877F2' }}>
              ...
              <a
                ...
                onClick={() => setShareOpen(false)}
              >
                <span className="share-network-icon" style={{ background: '#000' }}>
              ...
              <a
                ...
                onClick={() => setShareOpen(false)}
              >
                <span className="share-network-icon" style={{ background: '#25D366' }}>
              ...
              <a
                ...
                onClick={() => setShareOpen(false)}
              >
                <span className="share-network-icon" style={{ background: '#0A66C2' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#fff"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"/><circle cx="4" cy="4" r="2"/></svg>
                </span>
              ...
              <a
                ...
                onClick={() => setShareOpen(false)}
              >
                <span className="share-network-icon" style={{ background: '#555' }}>
