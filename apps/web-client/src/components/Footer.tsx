...
const socials = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/afroeventosec',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/afroeventosec/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true">
  ...
  {
    label: 'WhatsApp',
    href: 'https://wa.me/593988996579?text=Quiero%20m%C3%A1s%20informaci%C3%B3n',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true">
    ...
    <footer className="footer" id="main-footer">
      <div className="footer-inner">
        ...
        <p style={{ marginTop: '0.75rem', fontSize: '0.82rem', color: 'var(--text-muted)' }}>
          © {new Date().getFullYear()} AfroEventos. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
