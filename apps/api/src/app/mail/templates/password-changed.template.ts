...
export function passwordChangedTemplate(p: PasswordChangedProps): string {
  ...
  <tr>
    <td style="background:linear-gradient(160deg,#0a1a10 0%,#111318 100%);padding:48px 40px 36px;text-align:center;border-top:3px solid #6AC44D;">
      <div style="display:inline-block;width:72px;height:72px;border-radius:50%;background:rgba(106,196,77,0.12);border:2px solid rgba(106,196,77,0.3);line-height:72px;font-size:34px;margin-bottom:20px;">🔐</div>
